      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Audit and decisions', slug: 'concepts/audit' },
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'OpenAPI mode', slug: 'typescript/openapi' },
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Proxy mode', slug: 'python/proxy' },
            { label: 'OpenAPI mode', slug: 'python/openapi' },
